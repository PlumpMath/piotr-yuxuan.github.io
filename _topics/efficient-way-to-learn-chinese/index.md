...
That page doesn't contain much details about that project. If reading bores you, watch to [some pictures](https://www.github.com/{{ site.links.github | append: "/chinese-huawen" | append: "/tree/master/gephi" }}) of what I had got ☺ The [git repository](https://www.github.com/{{ site.links.github | append: "/chinese-huawen" }}) explains how to get started and expose the code. The [gh-pages](/chinese-huawen) branch contains some lengthy description of this project.
