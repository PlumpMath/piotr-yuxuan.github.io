---
title: "(old, not up-to-date) 華文: an efficient way to learn Chinese"
layout: page
collection: topics
changefreq: daily
...
> ## About this lengthy page
> This is way too long. At first I've been willing to split it in a subtopic ~/topics/efficient-way-to-learn-chinese/{pages} but jekyll seems not to like it. Moreover, it seems better to put back that documentation within the project repository so the address would be piotr-yuxuan.github.io/chinese-huawen/{pages}. This page is still the most up to date as you see this banner but this situation should change.
