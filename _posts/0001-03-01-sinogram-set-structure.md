 ...
 * Reflexive: $$x$$ is a component of itself. This is interesting to say a single sinogram can be a valid IDS. Moreover IDC has arities from 2 to 3 so if $$x$$ is not a component of itself we can't represent a radical IDS. This is why we choose to have not a strict partial order relation (when it's irreflexive) ;
